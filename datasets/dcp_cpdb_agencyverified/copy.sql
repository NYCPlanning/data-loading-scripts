...
\COPY bpl_mapped FROM './temp/dcp_cpdb_agencyverified/BPL_mapped.csv' CSV HEADER;
\COPY bpl_unmapped FROM './temp/dcp_cpdb_agencyverified/BPL_unmapped.csv' CSV HEADER;
...
\COPY dpr_mapped FROM './temp/dcp_cpdb_agencyverified/DPR_mapped.csv' CSV HEADER;
\COPY fdny_mapped FROM './temp/dcp_cpdb_agencyverified/FDNY_mapped.csv' CSV HEADER;
\COPY fdny_unmapped FROM './temp/dcp_cpdb_agencyverified/FDNY_unmapped.csv' CSV HEADER;
...
\COPY nycha_mapped FROM './temp/dcp_cpdb_agencyverified/NYCHA_mapped.csv' CSV HEADER;
\COPY nycha_unmapped FROM './temp/dcp_cpdb_agencyverified/NYCHA_unmapped.csv' CSV HEADER;
...
\COPY nypl_mapped FROM './temp/dcp_cpdb_agencyverified/NYPL_mapped.csv' CSV HEADER;
\COPY nypl_unmapped FROM './temp/dcp_cpdb_agencyverified/NYPL_unmapped.csv' CSV HEADER;
