...
DROP TABLE IF EXISTS dof_pts_ownernameaddress;
CREATE TABLE dof_pts_ownernameaddress (
...
COPY dof_pts_ownernameaddress
    FROM '/prod/data-loading-scripts/temp/dof_pts_ownernameaddress/dof_pts_ownernameaddress.csv'
    WITH  FORMAT CSV,
    DELIMITER '|',
    HEADER TRUE;